...
//!
//! Scope: bring the TX up for a **fixed 1080p60 RGB 8bpc TMDS** output, plus a
//! poll-mode DDC EDID read (`ddc`); no scrambling/SCDC (148.5 MHz < 340 MHz),
//! no audio, HDCP bypassed.
