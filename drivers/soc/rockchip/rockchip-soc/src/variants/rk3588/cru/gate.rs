...
clk_gate_table!(
    ...
    // ========================================================================
    // RGA2 叶子时钟门控 (CLKGATE_CON45 bits 7/8/9, verified against mainline
    // drivers/clk/rockchip/clk-rk3588.c; the aclk_vdpu_root parent is left
    // enabled by the bootloader, as for the JPEG decoder above)
    // ========================================================================
    HCLK_RGA2 => (45, 7),
    ACLK_RGA2 => (45, 8),
    CLK_RGA2_CORE => (45, 9),
