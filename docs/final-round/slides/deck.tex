...
\begin{frame}
  \navsegment{2}
  \frametitle{perf 真机证据：stat / record / report / top / kprobe / ftrace}
  \centering
  \includegraphics[width=\linewidth,height=0.82\textheight,keepaspectratio]{Fperf_proof.png}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.56\textwidth}
      \includegraphics[width=\linewidth]{Fpostgres_proof.png}
    \end{column}
