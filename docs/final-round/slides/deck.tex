...
\begin{frame}
  ...
  \begin{itemize}\setlength{\itemsep}{9pt}
    ...
    \item \headline{四\ \ 方法与复现}\quad{\color{muted}AI 使用与方法论、主要贡献、后续工作、材料入口}
  \end{itemize}}
  \vfill
...
\begin{frame}
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}p{2.4cm}>{\raggedright\arraybackslash}p{8.3cm}>{\centering\arraybackslash}m{1.9cm}@{}}
    ...
    机器人应用 & 网球拾取机器人五阶段闭环在 RK3588 真机完整运行，感知到运动控制全链路 & \vgood{已达} \\
    \bottomrule
  \end{tabular}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \headline{报告与幻灯}\ 决赛技术报告与进展汇报见 \texttt{docs/final-round/}，全部数字与图表经 \texttt{numbers.tex} 单一数据源溯源
  ...
  \advance{全部结论可追溯}{入口：上游 PR 与 QEMU 模型，docs/final-round 报告与幻灯，boardctl 暖回路}
\end{frame}
